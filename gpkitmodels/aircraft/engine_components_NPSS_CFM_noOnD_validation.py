...
##                A7 >= .1000*units('m^2'),
                ...
                mhtD <= 1.15*fp1*Mtakeoff*mCoreD *((1400/288)**.5)/(1221/101.325),
                mhtD >= .85*fp1*Mtakeoff*mCoreD *((1400/288)**.5)/(1221/101.325),
                mltD <= 1.15*fp1*Mtakeoff*mCoreD *((1082/288)**.5)/(537/101.325),
                mltD >= .85*fp1*Mtakeoff*mCoreD *((1082/288)**.5)/(537/101.325),
